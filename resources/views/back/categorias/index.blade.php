    ...
    <div class="container-fluid">
        <div class="block-header">
	        ...
	        <ol class="breadcrumb breadcrumb-col-teal">
	            ...
	            <li class="active"><i class="material-icons">person</i> Categorias</li>
	        </ol>
        </div>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <a href="{{ route('categorias.create') }}" class="btn btn-success waves-effect">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="item{{ $categoria->id }}">
                                            <td>{{ $categoria->nombre }} <br><small>{{ $categoria->slug }}</small></td>
                                            <td>{{ $categoria->resumen }}</td>
                                            <td>
                                                <a href="{{ route('categorias.show',$categoria->id) }}" class="btn btn-success waves-effect" title="Ver perfil">
                                                    <i class="material-icons">remove_red_eye</i>
                                                </a>
                                                <a href="{{ route('categorias.edit',$categoria->id) }}" class="btn btn-primary waves-effect" title="Editar">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <a href="{{ route('categorias.destroy',$categoria->id) }}" class="btn btn-danger waves-effect btn-delete-item" title="Eliminar">
