    ...
    <div class="container-fluid">
        <div class="block-header">
	        <ol class="breadcrumb breadcrumb-col-teal">
	            ...
	            <li class="active"><i class="material-icons">add</i> Nuevo cliente</li>
	        </ol>
        </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="POST" action="{{ route('clientes.store') }}" id="create-form" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('telefono') ? ' error' : '' }}">
                                    <input type="telefono" name="telefono" class="form-control"  value="{{ old('telefono') }}" >
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('contacto') ? ' error' : '' }}">
                                    <input type="contacto" name="contacto" class="form-control"  value="{{ old('contacto') }}" >
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('twitter_page') ? ' error' : '' }}">
                                    <input type="url" name="twitter_page" class="form-control"  value="{{ old('twitter_page') }}" >
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('instagram_page') ? ' error' : '' }}">
                                    <input type="url" name="instagram_page" class="form-control"  value="{{ old('instagram_page') }}" >
                            ...
                            <div class="form-group form-float">
                                <div class="form-line {{ $errors->has('youtube_page') ? ' error' : '' }}">
                                    <input type="url" name="youtube_page" class="form-control"  value="{{ old('youtube_page') }}" >
